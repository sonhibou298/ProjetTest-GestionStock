            ...
            <ul class="nav pcoded-inner-navbar">
                ...
                <li data-username="Authentication Sign up Sign in reset password Change password Personal information profile settings map form subscribe" class="nav-item pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class=""><a href="auth-signin.html" class="" target="_blank">Se deconnecter</a></li>
                    </ul>
                </li>
            </ul>
        </div>
           ...
           <div class="card-block px-0 py-3">
               <div class="table-responsive">
                   <table class="table table-hover">
                       <tbody>
                           <tr class="unread">
                               <td><img class="rounded-circle" style="width:40px;" src="public/assets/images/user/avatar-1.jpg" alt="activity-user"></td>
                               <td>
                           ...
                           <tr class="unread">
                               <td><img class="rounded-circle" style="width:40px;" src="public/assets/images/user/avatar-2.jpg" alt="activity-user"></td>
                               <td>
                           ...
                           <tr class="unread">
                               <td><img class="rounded-circle" style="width:40px;" src="public/assets/images/user/avatar-3.jpg" alt="activity-user"></td>
                               <td>
